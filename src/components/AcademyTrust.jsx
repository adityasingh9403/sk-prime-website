        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-stretch">
          ...
          >
            ...
            <div className="relative z-10 pt-16">
              <button className="w-full py-5 bg-[#D4AF37] text-white rounded-2xl font-black text-[10px] uppercase tracking-[0.3em] hover:bg-white hover:text-slate-900 transition-all shadow-xl shadow-slate-900/20 flex items-center justify-center gap-3">
